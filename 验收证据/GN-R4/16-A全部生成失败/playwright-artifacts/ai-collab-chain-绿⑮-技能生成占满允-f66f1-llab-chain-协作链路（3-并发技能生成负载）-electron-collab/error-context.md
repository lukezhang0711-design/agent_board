...
- generic [ref=e3]:
  - navigation "Open projects" [ref=e4]:
    - button "Switch to project nimbalyst-test-izJ7gQ" [ref=e6] [cursor=pointer]: NT
  ...
  - generic [ref=e56]:
    - generic [ref=e58]:
      - generic [ref=e60]:
        - generic [ref=e61]:
          - heading "nimbalyst-test-izJ7gQ" [level=3] [ref=e63]
          - generic [ref=e64]:
            ...
            - button "Create new session, worktree, or terminal" [ref=e75] [cursor=pointer]:
              - img [ref=e76]
        - generic "/var/folders/st/r866ph290_35q34xmk31xmzm0000gn/T/nimbalyst-test-izJ7gQ" [ref=e78]
      ...
      - generic [ref=e94]:
        ...
        - 'button "Session: New Session, updated Just now" [ref=e117] [cursor=pointer]':
          ...
          - generic [ref=e121]:
            ...
            - generic [ref=e123]:
              - generic "2026年9月7日 GMT+8 下午10:25" [ref=e124]: Just now
      ...
      - generic [ref=e129]:
        - generic [ref=e131]:
          - generic [ref=e132]:
            ...
            - generic [ref=e137]: nimbalyst-test-izJ7gQ · 0 个在跑 · 0 个等你确认
          - generic [ref=e139]:
...
> 1616 |     expect(res.success).toBe(true);
  ...
  1699 |     },
  1700 |   ].map(skill => ({ ...skill, description: `${skill.description}\nGN-R4-LOAD ${skill.name}` }));
  1701 | 
  1702 |   const skillGenPromisesPhase3 = phase3Skills.map((s) =>
  1703 |     invokeElectron<{ success: boolean; summaryZh?: string; enrichmentFailed?: boolean }>(
  1704 |       page,
  1705 |       'dispatch-skills:generate-summary',
  1706 |       s,
  1707 |     ),
  1708 |   );
  1709 | 
  1710 |   // 等待第 3 阶段在跑数达到 3
  1711 |   await expect.poll(async () => countRunningEngineProcesses(), { timeout: 10_000 }).toBe(3);
  1712 |   const phase3LiveProcs = await getLiveEngineProcessInfo();
  1713 |   const phase3 = await capturePhase(3, phase3Skills, phase3LiveProcs);
  1714 |   await assertNodeLoad(phase3, 'start');
  1715 | 
  1716 |   // 在并发负载下完成总指挥收敛总结与交付
```