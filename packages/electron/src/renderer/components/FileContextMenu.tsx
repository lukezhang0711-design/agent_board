...
export function FileContextMenu({
    ...
    return (
      <FloatingPortal>
        <div
          ...
          className="file-context-menu file-context-menu-rename p-2 min-w-[250px] rounded-ui-base z-[10000] backdrop-blur-[10px] shadow-[0_4px_12px_rgba(0,0,0,0.15)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.5)]"
        >
  ...
  const menuItemClasses = "file-context-menu-item flex items-center gap-3 px-3 py-2 rounded-ui-base cursor-pointer transition-colors text-[var(--nim-text)] hover:bg-[var(--nim-bg-hover)]";
  const dangerItemClasses = "file-context-menu-item file-context-menu-item-danger flex items-center gap-3 px-3 py-2 rounded-ui-base cursor-pointer transition-colors text-[var(--nim-error)] hover:bg-[var(--nim-error-subtle)]";
