...
export function UpdateAvailableToast({
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <div
        className="update-toast-title text-ui-body font-semibold text-[var(--nim-text)] mb-1 pr-7"
        data-testid="update-toast-version"
      >
        New Version: Nimbalyst {version}
      </div>
      <div className="update-toast-subtitle text-ui-compact text-[var(--nim-text-muted)] leading-normal mb-3" data-testid="customized-build-notice">
        This is a customized build; updates are review-and-merge, not auto-installed.
      </div>
      <div className="update-toast-notes text-ui-compact text-[var(--nim-text-muted)] leading-normal mb-4 max-h-24 overflow-y-auto whitespace-pre-wrap" data-testid="update-release-notes">
      ...
      <div className="update-toast-actions flex gap-2 flex-wrap">
        <button
          className="update-toast-btn update-toast-btn-text py-2 px-3 border-none rounded-ui-base text-ui-body font-medium cursor-pointer transition-all duration-200 font-[inherit] whitespace-nowrap bg-transparent text-[var(--nim-text-muted)] hover:text-[var(--nim-text)] hover:bg-[var(--nim-bg-hover)]"
