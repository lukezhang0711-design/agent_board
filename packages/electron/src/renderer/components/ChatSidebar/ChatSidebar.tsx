    ...
    >
      ...
      <div className="chat-sidebar-header flex items-center gap-2 p-2 border-b border-nim justify-between shrink-0">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            className="chat-sidebar-new-button flex items-center gap-1 px-3 py-2 rounded-ui-base text-ui-body font-medium bg-nim-primary text-nim-on-primary border-none cursor-pointer transition-opacity duration-150 hover:opacity-90"
