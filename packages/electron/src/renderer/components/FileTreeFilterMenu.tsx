  ...
  return (
    <FloatingPortal>
      ...
      >
        ...
        <div
          className={`filter-menu-item flex items-center gap-3 px-3 py-2 rounded-ui-base cursor-pointer relative transition-colors text-[var(--nim-text)] hover:bg-[var(--nim-bg-hover)] ${currentFilter === 'all' ? 'active bg-[var(--nim-bg-selected)]' : ''}`}
        ...
        <div
          className={`filter-menu-item flex items-center gap-3 px-3 py-2 rounded-ui-base cursor-pointer relative transition-colors text-[var(--nim-text)] hover:bg-[var(--nim-bg-hover)] ${currentFilter === 'markdown' ? 'active bg-[var(--nim-bg-selected)]' : ''}`}
        ...
        <div
          className={`filter-menu-item flex items-center gap-3 px-3 py-2 rounded-ui-base cursor-pointer relative transition-colors text-[var(--nim-text)] hover:bg-[var(--nim-bg-hover)] ${currentFilter === 'known' ? 'active bg-[var(--nim-bg-selected)]' : ''}`}
        ...
        <div
          className={`filter-menu-item flex items-center gap-3 px-3 py-2 rounded-ui-base relative transition-colors text-[var(--nim-text)] ${!isGitRepo ? 'disabled opacity-60 cursor-not-allowed' : 'cursor-pointer hover:bg-[var(--nim-bg-hover)]'} ${currentFilter === 'git-uncommitted' ? 'active bg-[var(--nim-bg-selected)]' : ''}`}
        ...
        {isGitWorktree && (
          <div
            className={`filter-menu-item flex items-center gap-3 px-3 py-2 rounded-ui-base cursor-pointer relative transition-colors text-[var(--nim-text)] hover:bg-[var(--nim-bg-hover)] ${currentFilter === 'git-worktree' ? 'active bg-[var(--nim-bg-selected)]' : ''}`}
        ...
        <div
          className={`filter-menu-item flex items-center gap-3 px-3 py-2 rounded-ui-base relative transition-colors text-[var(--nim-text)] ${!hasActiveClaudeSession ? 'disabled opacity-60 cursor-not-allowed' : 'cursor-pointer hover:bg-[var(--nim-bg-hover)]'} ${currentFilter === 'ai-read' ? 'active bg-[var(--nim-bg-selected)]' : ''}`}
        ...
        <div
          className={`filter-menu-item flex items-center gap-3 px-3 py-2 rounded-ui-base relative transition-colors text-[var(--nim-text)] ${!hasActiveClaudeSession ? 'disabled opacity-60 cursor-not-allowed' : 'cursor-pointer hover:bg-[var(--nim-bg-hover)]'} ${currentFilter === 'ai-written' ? 'active bg-[var(--nim-bg-selected)]' : ''}`}
        ...
        <div
          className="filter-menu-item flex items-center gap-3 px-3 py-2 rounded-ui-base cursor-pointer relative transition-colors text-[var(--nim-text)] hover:bg-[var(--nim-bg-hover)]"
