  ...
  return (
    <HelpTooltip testId="plan-mode-toggle">
      <button
        ...
        className={`mode-tag px-3 py-0.5 rounded-ui-lg text-ui-caption font-semibold uppercase tracking-wide border-none transition-all duration-200 outline-none ${disabled ? 'cursor-not-allowed opacity-55' : 'cursor-pointer hover:-translate-y-px hover:shadow-md active:translate-y-0'} ${
          mode === 'planning'
