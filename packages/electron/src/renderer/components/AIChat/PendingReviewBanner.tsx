  ...
  return (
    <div className="pending-review-banner flex items-center justify-between px-3 py-2 bg-amber-400/10 border-b border-amber-400/30">
      <div className="pending-review-banner__info flex items-center gap-2">
        ...
        <span className="pending-review-banner__text text-ui-compact text-nim-warning font-medium">
          <span className="pending-review-banner__count font-semibold">{pendingCount}</span>
          {' '}file{pendingCount !== 1 ? 's' : ''} pending review
        </span>
      </div>
      <button
        className="pending-review-banner__clear-btn flex items-center gap-1 px-3 py-1 bg-transparent border border-nim-warning rounded-ui-base text-nim-warning text-ui-caption font-medium cursor-pointer transition-all duration-200 font-inherit hover:enabled:bg-amber-400/15 disabled:opacity-50 disabled:cursor-not-allowed"
