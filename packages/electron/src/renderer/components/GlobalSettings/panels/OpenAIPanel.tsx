      ...
      {config.enabled && (
        <>
          <div className="provider-panel-section py-4 mb-4 border-b border-[var(--nim-border)] last:border-b-0 last:mb-0 last:pb-0">
            <h4 className="provider-panel-section-title text-ui-subhead font-semibold mb-3 text-[var(--nim-text)]">API Configuration</h4>
          ...
          <div className="provider-panel-section py-4 mb-4 border-b border-[var(--nim-border)] last:border-b-0 last:mb-0 last:pb-0">
            ...
            {loading && (
              <div className="models-loading text-ui-body text-[var(--nim-text-muted)] py-2">Loading models...</div>
            )}

            {!loading && availableModels.length > 0 && (
              <div className="models-section">
                <div className="models-header flex items-center justify-between mb-3">
                  <span className="text-ui-body text-[var(--nim-text-muted)]">Select models to enable:</span>
            ...
            {!loading && availableModels.length === 0 && apiKeys.openai && (
              <div className="models-loading text-ui-body text-[var(--nim-text-muted)] py-2">No models available. Check your API key and connection.</div>
            )}
          </div>
        </>
      )}
