      ...
      <div className="unified-diff-header-content flex items-center justify-between py-2 px-4 gap-4 min-h-[48px]">
        ...
        <div className="unified-diff-header-info flex items-center gap-3 shrink min-w-0 overflow-hidden">
          {sessionInfo?.sessionTitle ? (
            <div className="unified-diff-header-session flex items-center gap-2 text-ui-body text-[var(--nim-text)] min-w-0 overflow-hidden">
          ...
          {sessionInfo?.sessionId && onGoToSession && (
            <button
              className="unified-diff-header-goto flex items-center gap-1 px-2 py-1 bg-transparent border-none rounded-ui-base text-ui-body text-[var(--nim-text-muted)] cursor-pointer transition-colors duration-150 hover:bg-[var(--nim-bg-hover)] hover:text-[var(--nim-text)]"
